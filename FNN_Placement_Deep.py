...
new_student = pd.DataFrame([[70,75,80,85,1]], columns=['Aptitude', 
                                                       'Coding', 
                                                       'Communication', 
                                                       'Academics', 
                                                       'Internship'
...
new_probality = loaded_model.predict_proba(new_student_scaled)

print("New Students Data :")

print(new_student)

print("Prediction Probablity :",new_probality)
